    ...
    return (
        <React.Fragment>
            ...
            <div className={classes["file-card"]}>
                ...
                {props.imageType === "advertistment" && <p className={classes.info}>JPG, PNG</p>}
                {props.imageType === undefined && <p className={classes.info}>PDF, JPG, PNG</p>}
            </div>
            {props.imageType === "advertistment" &&
                <CardMedia
                    component="img"
                    image={
                        imagePreview !== null ?
